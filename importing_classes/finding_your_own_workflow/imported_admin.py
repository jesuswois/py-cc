...
from imported_admin_classes import Admin

admin_user = Admin("Johny","Cash Cash","johny$gmail.com","male",18,["can ban users",
                                                                    "can change user's credentials",
                                                                    "can delete the entire database"])
